                    ...
                    <form action="{{ route('signs.update', $sign) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                is-invalid
                            @enderror"
                                    name="description" value="{{ $sign->description }}">
                                @error('description')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
